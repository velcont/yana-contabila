        ...
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
              ...
              {accessType !== 'trial' && accessType !== 'free_access' && daysLeft !== null && (
                <span className="text-xs">Reînnoire în {daysLeft} {daysLeft === 1 ? 'zi' : 'zile'}</span>
              )}
          ...
          <TooltipContent>
            <div className="text-sm">
              <p className="font-medium">Plan: Yana Strategic</p>
              {subscriptionEnd && (
                <p className="text-xs text-muted-foreground mt-1">
