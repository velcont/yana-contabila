...
export function SuggestionChips({ onSendMessage, onUpload, disabled, postAnalysis }: SuggestionChipsProps) {
  ...
  return (
    <div className="flex gap-2 py-2 overflow-x-auto flex-nowrap justify-start lg:justify-center -mx-1 px-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden snap-x [mask-image:linear-gradient(to_right,transparent,black_12px,black_calc(100%-12px),transparent)]">
      {chips.map((chip) => {
