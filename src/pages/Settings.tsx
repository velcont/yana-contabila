        ...
        <Tabs defaultValue="profile" className="space-y-6">
          <TooltipProvider>
            <TabsList className="flex w-full overflow-x-auto gap-1 p-1 no-scrollbar sm:grid sm:grid-cols-6">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <TabsTrigger value="integrations" className="flex-shrink-0 gap-1.5 px-3 min-w-[44px]">
                    <Plug className="h-4 w-4" />
                    <span className="hidden sm:inline">Integrări</span>
                  </TabsTrigger>
                </TooltipTrigger>
                <TooltipContent className="sm:hidden">Integrări</TooltipContent>
              </Tooltip>
